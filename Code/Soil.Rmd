...
## Soil Temperature
```{r graph2, include=T, fig.width=8, fig.height=6, out.width="90%", dependson='data-setup'}
# Soil Temperature
# X-axis = Date from April 1st to Oct 31, fixed.
...
## Soil Nitrogen
```{r graph3, include=T, fig.width=8, fig.height=6, out.width="90%", dependson='data-setup'}
# Soil Nitrogen
# X-axis = Date from April 1st to Oct 31, fixed.
